...
if __name__ == '__main__':
    ...
    For debbuging purpose only:
        python from_box_to_desi_sv3_cutsky.py
    """
    ...
    mock = LagrangianLinearMock(power, nmesh=256, boxsize=boxsize, boxcenter=boxcenter, seed=None, unitary_amplitude=False)
    ...
    for region in regions:
        ...
        rosettes_regions[region] = [rosette for rosette, radec in direction_rosettes.items() if mask_region(radec[1], region)]
